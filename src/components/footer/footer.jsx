...
const Footer = () => {
  return (
    <Box bgColor="gray.200" py={2} mt={"100px"} borderRadius={"15px"}>
      <Flex
      ...
      >
        ...
        <Stack spacing={4} textAlign="center" mb={{ base: 8, md: 0 }}>
          ...
          <Link href="/components" fontSize="sm" color="gray.600">
            Presets
          </Link>
          <Link href="/components/card" fontSize="sm" color="gray.600">
            Card
          </Link>
          <Link href="/components/loginForm" fontSize="sm" color="gray.600">
            Auth From
          </Link>
          <Link href="/" fontSize="sm" color="gray.600">
            Landing
        ...
        <Stack spacing={4} textAlign="center" mb={{ base: 8, md: 0 }}>
          ...
          <Flex justify="center">
            ...
            <Link
              ...
              mr={2}
            >
              <Icon as={FaLinkedin} boxSize={6} color="gray.600" />
            </Link>
          </Flex>
        </Stack>
      </Flex>
